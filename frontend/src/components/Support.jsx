...
// Function to display the Contact Support component.
const Support = () => {
  return (
    <div className="flex items-center justify-center bg-neutral-100 px-8 py-24 text-neutral-800 shadow-lg">
      <BlockInTextCard
        tag="/ Support"
        text={
          <>
        ...
        examples={[
          "Does your product update my file when I make changes?",
          "Can I cancel my membership?",
          "Can't find a recently deleted contact?",
          "Privacy Policy?",
        ]}
      />
    </div>
...
// Function to display the BlockInTextCard component.
...
// Constants for the Typewrite component.
...
const Typewrite = ({ examples }) => {
  ...
  // Function to display the Typewrite component.
  return (
